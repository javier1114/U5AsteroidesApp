...
import mx.edu.itl.c19130917.u5asteroidesapp.R;
...
public class VistaJuegoView extends View {
    ...
    public VistaJuegoView ( Context context, AttributeSet attrs ) {
        ...
        drawableNave = context.getResources().getDrawable(R.drawable.messi);
        drawableMisil = context.getResources().getDrawable(R.drawable.copa1);
        drawableAsteroide [0] = context.getResources().getDrawable(R.drawable.cr73);
        drawableAsteroide [1] = context.getResources().getDrawable(R.drawable.cr72);
        drawableAsteroide [2] = context.getResources().getDrawable(R.drawable.cr71);
